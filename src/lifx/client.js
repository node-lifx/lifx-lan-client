...
class Client {
   ...
   */
  getMessageQueue(queueAddress = this.broadcastAddress) {
   ...
   * @param {String} queueAddress Message queue id
   */
  startSendingProcess(queueAddress = this.broadcastAddress) {
   ...
   * @param {String} queueAddress Message queue id
   */
  stopSendingProcess(queueAddress = this.broadcastAddress) {
